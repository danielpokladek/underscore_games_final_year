...
public class RoomSelector : MonoBehaviour
{
    ...
    public RoomContainer dungeonContainer;
    ...
    private void PickRoom()
    {
        ...
        tempRoom.GetComponent<RoomManager>().SetRoomType(roomType);
    }

    #region RoomSelector Stuff - Only open if you dare.
    ...
    private void SpawnDungeonRoom()
    {
        switch (doorDest)
        {
            case 1:
                // UP ONLY
                tempRoom = Instantiate(
                    dungeonContainer.roomUp[Random.Range(0, dungeonContainer.roomUp.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 2:
                // DOWN ONLY
                tempRoom = Instantiate(
                    dungeonContainer.roomDown[Random.Range(0, dungeonContainer.roomDown.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 4:
                // LEFT ONLY
                tempRoom = Instantiate(
                    dungeonContainer.roomLeft[Random.Range(0, dungeonContainer.roomLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 8:
                // RIGHT ONLY
                tempRoom = Instantiate(
                    dungeonContainer.roomRight[Random.Range(0, dungeonContainer.roomRight.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 3:
                // UP - DOWN
                tempRoom = Instantiate(
                    dungeonContainer.roomUpDown[Random.Range(0, dungeonContainer.roomUpDown.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 12:
                // RIGHT - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomRightLeft[Random.Range(0, dungeonContainer.roomRightLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 9:
                // UP - RIGHT
                tempRoom = Instantiate(
                    dungeonContainer.roomUpRight[Random.Range(0, dungeonContainer.roomUpRight.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 5:
                // UP - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomUpLeft[Random.Range(0, dungeonContainer.roomUpLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 10:
                // RIGHT - DOWN
                tempRoom = Instantiate(
                    dungeonContainer.roomRightDown[Random.Range(0, dungeonContainer.roomRightDown.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 6:
                // DOWN - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomDownLeft[Random.Range(0, dungeonContainer.roomDownLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 7:
                // UP - DOWN - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomUpDownLeft[Random.Range(0, dungeonContainer.roomUpDownLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 13:
                // UP - RIGHT - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomUpRightLeft[Random.Range(0, dungeonContainer.roomUpRightLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 11:
                // UP - RIGHT - DOWN
                tempRoom = Instantiate(
                    dungeonContainer.roomUpRightDown[Random.Range(0, dungeonContainer.roomUpRightDown.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 14:
                // RIGHT - DOWN - LEFT
                tempRoom = Instantiate(
                    dungeonContainer.roomRightDownLeft[Random.Range(0, dungeonContainer.roomRightDownLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
            ...
            case 15:
                // ALL FOUR
                tempRoom = Instantiate(
                    dungeonContainer.roomUpDownRightLeft[Random.Range(0, dungeonContainer.roomUpDownRightLeft.Length)],
                    transform.position, Quaternion.identity);
                break;
        }
    }
